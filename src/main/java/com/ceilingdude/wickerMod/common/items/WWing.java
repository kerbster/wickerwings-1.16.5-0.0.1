...
public class WWing extends ArmorItem{
	
	public WWing(WickerMaterial wicker, EquipmentSlotType chest, Properties properties) {
		super(WickerMaterial.WICKER, EquipmentSlotType.CHEST, properties);
	}
